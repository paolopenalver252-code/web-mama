...
export default function CardCenter({ name, location, description, href }: Center) {
  return (
    <div className="overflow-hidden rounded-2xl border border-primary/5 bg-surface shadow-soft">
      <PlaceholderImage label="Fotografía pendiente" className="aspect-[16/9] w-full rounded-none" />
