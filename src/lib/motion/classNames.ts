...
export const cardHover =
  `transition-all duration-300 ${brandEase} hover:-translate-y-1 hover:border-accent/30 hover:shadow-[0_20px_45px_rgba(15,45,82,0.1)]`;

export const cardHoverDark =
  `transition-all duration-300 ${brandEase} hover:-translate-y-1 hover:border-accent/30 hover:bg-white/[0.08]`;
